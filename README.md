...
Follow the setup wizard to install dependencies and configure your API key
...
Assistant: Conversational interface for voice or text interaction
Health Tracking: Record and view health metrics
Medications: Manage medication schedule and reminders
Profile: Update personal information and emergency contacts
Settings: Customize voice and display preferences
Voice Commands
...
Voice Settings: Adjust speed and volume in the Settings tab
Display Settings: Change font size and color theme for better visibility
Reminder Frequency: Adjust how often you receive medication reminders
User Profile: Customize health conditions and medications
